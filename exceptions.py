"""
Global wikifur exception and warning classes.
"""
import sys
ODD_ERROR_MESSAGE = "This shouldn't happen. Please report on GitHub: github.com/goldsmith/wikifur"
class wikifurException(Exception):
  """Base wikifur exception class."""
...
class PageError(wikifurException):
  """Exception raised when no wikifur matched a query."""
...
class DisambiguationError(wikifurException):
  ...
  of wikifur pages that the query may refer to.
  .. note:: `options` does not include titles that do not link to a valid wikifur page.
  """
